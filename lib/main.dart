...
import 'package:mind_wave/HomeScreen.dart';
import 'package:mind_wave/IntroScreen.dart';
import 'package:mind_wave/WelcomeScreen.dart';
...
class _AccessState extends State<Access> {
  ...
  void getCurrentUser() async {
    ...
    try {
      if (sharedPreferences.getString("MindWave101") != null) {
        setState(() {
          patientInfo.email = sharedPreferences.getString("MindWave101")!;
          userAvailable = true;
        });
      }
    } catch (e) {
                        ...
                        onPressed: () async {
                          ...
                          if (email.isNotEmpty && password.isNotEmpty) {
                            if (password.length < 6) {
                              ...
                              sharedPreferences.setString("MindWave101", email);
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
